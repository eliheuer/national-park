...
thisFont="NationalPark"    # The name of the font family
...
do
    ...
    #cp $vf ~/Google/fonts/ofl/fontname/
done
rm ../fonts/variable/*backup*.ttf
#mv ~/Google/fonts/ofl/fontname/FontName-Roman-VF.ttf ~/Google/fonts/ofl/forname/FontName-Regular.ttf
